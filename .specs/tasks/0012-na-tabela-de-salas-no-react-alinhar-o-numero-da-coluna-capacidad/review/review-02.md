...
- docs/screens/screen-rooms-list.md:264 — o documento de tela descreve prioridade de Nome, text-center em Capacidade, xl:w-[10%] e Ações centralizada, coerente com a página.
...
- resources/js/Pages/Room/Index.jsx:126 — coluna Nome permanece min-w-0 w-full, sem max-width nem xl:w-[10%].
...
- resources/js/Pages/Room/Index.test.jsx:118 — Nome mantém w-full + min-w-0 e não recebe xl:w-[10%].
- resources/js/Pages/Room/Index.test.jsx:134 — colunas secundárias exigem w-0, xl:w-[10%] e whitespace-nowrap nos headers.
