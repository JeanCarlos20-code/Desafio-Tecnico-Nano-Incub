...
6. Preencha `harness.commits` em `tasks.md` seguindo `harness/skills/conventional-commits/SKILL.md` (`type(module):` em inglês; um commit por módulo; testes separados).
...
12. `tasks.md` deve explicar solução, abordagens consideradas, testes a criar/alterar/executar, gates e frontmatter do harness.
